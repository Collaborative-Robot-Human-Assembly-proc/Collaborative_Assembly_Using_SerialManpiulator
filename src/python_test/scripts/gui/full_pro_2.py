...
class fullPro(object):
    def __init__(self):
        ...
        # For Initializing subscriber from GUI, any comment below "Case 1" must be running and "Case 2" must be stopped.
        
        # For a Predefined parts to be sent the full process immediately, any comment below "Case 2" must be 
        # running and "Case 1" must be stopped.
        ...
        # Case 2
        self._list_callback([['1','bolt1','bolt','6'],['1','bearing1','bearing','7'],['1','bearing2','bearing','6'],['1','bolt1','nut','7'],['1','bearing3','bearing','9'],['1','bolt1','nut','9'],['1','bolt1','bolt','6'],['1','bolt1','bearing','6'],['1','bolt1','nut','6'],['1','bolt1','bolt','7'],['1','bolt1','bearing','8'],['1','bolt1','nut','8'],['1','bolt1','gear','8'],['1','bolt1','gear','8'],['1','bolt1','bearing','7'],['1','bolt1','bolt','9'],['1','bolt1','gear','9']])
    ...
    def _list_callback(self,list_analyzed):
        ...
        if done == True:
            ...
            # Case 1
            # analyzed_parts = [inner_string.split(', ') for inner_string in list_analyzed.data.split('\n')]


            # Case 2
            analyzed_parts  = list_analyzed
            ...
            for sublist in self.available_analyzed_parts:
                ...
                self.name,self.size = sublist[2:]
                print(f'iteration: {self.name,self.size}')
                
                grid_point = next(item[1] for item in self.grid_points if item[0] == self.size)
                print(grid_point)
                ...
                result = [part_position[1] for part_position in returned_list if part_position[0] == self.name]
                try:
                    print(result)
                    ...
                    # Select End effector tool according your preference, and thresholds according to your customizations
                    if self.name == 'gear':
                    ...
                    elif self.name == 'bearing':
                        self.referred_link = 'tool0_magnetic_tip'
                        part_position.pose.position.z+=0.00

                    else:
                        self.referred_link = 'tool0_gripper_outer'
                        self.proxy(signal='valve',value='1')
                        part_position.pose.position.z+=0.0045
                        self.value = '0'
                    ...
                    if self.referred_link == 'tool0_gripper_outer' or 'tool0_magnetic_tip':
                        # if you want the part to get to your hand (Pose estimate), use this line:
                        # self.hand_pose_target()

                        # else, a predefined location:
                    ...
                    self.p_2.publish(f'{self.name} {self.size} is sent.')
                
                except:
                    self.p_2.publish(f'{self.name} {self.size} already been taken.')
    ...
    def get_part(self,point_response):
        ...
        try:
            ...
            new_eef_pose.position =  copy.deepcopy(base_point.pose.position)
            if self.name=='bearing' or 'nut':
                if self.size == '6' or '8':
                    new_eef_pose.position.z -= 0.003
